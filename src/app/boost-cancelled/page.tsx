...
import BoostCancelledContent from '../../components/BoostCancelled';
...
// //   // FIX: Removed useState hook and replaced with a constant as it's only set once.
// //   const redirectPath = orgId ? `/org/${orgId}/dashboard` : '/';
