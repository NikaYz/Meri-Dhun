...
export default function SocketHandler(req: NextApiRequest, res: NextApiResponseServerIO) {
  if (res.socket.server.io) {
    ...
    io.on('connection', (socket) => {
      ...
      socket.on('join-organization', ({ organizationId,sessionId }) => {
      ...
      // Event broadcasts
      const events = ['song-played', 'song-voted', 'song-boosted', 'special-request', 'leaderboard-updated', 'now-playing-updated', 'skip-song']
