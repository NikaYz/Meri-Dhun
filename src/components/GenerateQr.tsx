...
export default function GenerateQr({ organizationId }: GenerateQrProps) {
  ...
  // FIX: Removed `expiresAt` as it was not being used and is redundant with the countdown.
  ...
  useEffect(() => {
    ...
    const fetchToken = async () => {
      try {
        ...
        setToken(data.token);
        // FIX: Removed the line `setExpiresAt(new Date(data.expiresAt));`
  ...
  // FIX: Added a new "Open Link" button that calls this function.
            ...
            <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {/* FIX: Added a new button to utilize the `handleRedirect` function */}
                  <button
